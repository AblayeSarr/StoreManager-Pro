...
class VenteService {
    ...
    //Enregistre une vente avec ses lignes et décrémente le stock dans une transaction.
    ...
    public function enregistrerVente(
        ...
        try {
            ...
            $stmt = $this->pdo->prepare(
                "INSERT INTO ventes
                (utilisateur_id, client_id, montant_total, statut)
                VALUES
                (:utilisateur_id, :client_id, :montant_total, 'en_cours')"
            );
